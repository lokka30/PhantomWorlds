...
public class SetSpawnSubcommand implements Subcommand {
  ...
  public void parseCommand(CommandSender sender, Command cmd, String label, String[] args) {
    ...
    (new MultiMessage(
            ...
            new MultiMessage.Placeholder("x", String.valueOf(Utils.roundTwoDecimalPlaces(x)), false),
            new MultiMessage.Placeholder("y", String.valueOf(Utils.roundTwoDecimalPlaces(y)), false),
            new MultiMessage.Placeholder("z", String.valueOf(Utils.roundTwoDecimalPlaces(z)), false),
            new MultiMessage.Placeholder("yaw", String.valueOf(Utils.roundTwoDecimalPlaces(yaw)), false),
            new MultiMessage.Placeholder("pitch", String.valueOf(Utils.roundTwoDecimalPlaces(pitch)), false)
    ))).send(sender);
  }
