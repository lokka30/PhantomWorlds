        ...
        (new MultiMessage(
            ...
            Arrays.asList(
                ...
                new MultiMessage.Placeholder("amount",
                    main.compatibilityChecker.incompatibilities.size() + "", false)
            ))).send(sender);

        for(int i = 0; i < main.compatibilityChecker.incompatibilities.size(); i++) {
            CompatibilityChecker.Incompatibility incompatibility = main.compatibilityChecker.incompatibilities.get(
                i);
